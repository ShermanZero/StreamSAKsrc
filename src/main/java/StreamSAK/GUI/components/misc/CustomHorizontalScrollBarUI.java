...
public class CustomHorizontalScrollBarUI extends BasicScrollBarUI {
	...
	public CustomHorizontalScrollBarUI(Color background, Color foreground, Color foregroundSelect) {
		super();
	...
	protected void paintThumb(Graphics g, JComponent c, Rectangle r) {
		...
		g2.fillRoundRect(r.x, r.y, r.width, this.height, 5, 5);
		g2.dispose();
	  }
	
	@Override
	protected void setThumbBounds(int x, int y, int width, int height) {
		super.setThumbBounds(x, y, width, this.height);
		scrollbar.repaint();
	}
